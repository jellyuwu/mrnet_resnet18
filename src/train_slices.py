...
from train_baseline import train_model, evaluate_model, get_lr
...
LR: {}""".format(
    ...
    device, args.epochs, args.augment_prob, config.LEARNING_RATE), file=f)
    ...
    print('[TRAIN] NUM_SLICES = {}'.format(config.NUM_SLICES))
        ...
        if val_auc > best_val_auc:
            ...
            if bool(args.save_model):
                ...
                model_filename = '{}/model_{}_{}_{}_train_auc_{:.4f}_val_auc_{:.4f}_train_loss_{:.4f}_val_loss_{:.4f}_epoch_{}_arch_{}_cut_{}_augment_{}_augment-probability_{}.pth'.format(
                    config.TRAIN_MODELS_PATH_SLICES, args.prefix_name, args.task, args.plane, 
